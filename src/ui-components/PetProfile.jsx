...
export default function PetProfile(props) {
  ...
  const buttonThreeSixFourNineTwoSixNineFiveOnClick = useDataStoreDeleteAction({
    model: Pet,
    id: pet?.id,
    schema: schema,
  });
  ...
  return (
    ...
    >
      <Button
        ...
        children="Deletar"
        onClick={() => {
          buttonThreeSixFourNineTwoSixNineFiveOnClick();
        }}
        {...getOverrideProps(overrides, "Button36492695")}
      ></Button>
      <Image
        width="160px"
        height="160px"
      ...
      >
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children={pet?.breed}
          {...getOverrideProps(overrides, "Ra\u00E7a")}
        ></Text>
      </Flex>
      <Flex
        gap="16px"
      ...
      <Button
        ...
        variation="primary"
        children="Editar"
        {...getOverrideProps(overrides, "Button36492689")}
      ></Button>
    </Flex>
  );
}
